...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Plataforma frontend completa de e-commerce desenvolvida com React e TypeScript. Interface moderna e responsiva com carrinho de compras e integração com APIs.",
    descriptionEn:
      "Complete e-commerce frontend platform developed with React and TypeScript. Modern and responsive interface with shopping cart and API integration.",
  ...
  },
  {
    ...
    description:
      "Backend completo para plataforma de e-commerce desenvolvido com Node.js. APIs RESTful para gerenciamento de produtos, usuários, pedidos e pagamentos.",
    descriptionEn:
      "Complete backend for e-commerce platform developed with Node.js. RESTful APIs for product, user, order, and payment management.",
  ...
  },
  {
    ...
    title: "Note Creator",
    description:
      "Aplicação web para criação e gerenciamento de notas desenvolvida durante a NLW. Interface intuitiva com funcionalidades de criação, edição e organização de notas.",
    descriptionEn:
      "Web application for creating and managing notes developed during NLW. Intuitive interface with note creation, editing, and organization features.",
