...
const translations = {
  pt: {
    ...
    'hero.description': 'Desenvolvedor Web Fullstack com mais de 1 ano de experiência, focado na criação de aplicações modernas, performáticas e orientadas a resultados. Aplicando boas práticas de engenharia de software como SOLID, Clean Code e convenções de commit.',
  ...
  en: {
    ...
    'hero.description': 'Fullstack Web Developer with over 1 year of experience, focused on creating modern, performant, and results-oriented applications. Applying software engineering best practices such as SOLID, Clean Code, and commit conventions.',
